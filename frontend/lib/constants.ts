...
const BASE_ROLE_DISPLAY_LABELS: Record<string, string> = {
  ...
  skeptic: "Скептик",
  portfolio_strategist: "Портфельный стратег",
  market_scout: "Скаут рынка",
  pivot_critic: "Критик пивота",
  product_strengthener: "Усилитель продукта",
  growth_operator: "Оператор роста",
  execution_critic: "Критик исполнения",
