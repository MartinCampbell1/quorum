...
def test_execution_brief_endpoint_exports_brief_from_session():
    ...
    store.update(
        ...
        workspace_paths=["/Users/martin/Desktop/Projects/graphrag-affiliate"],
    )
...
def test_send_to_autopilot_endpoint_forwards_brief():
    ...
    with patch("orchestrator.api.generate_session_execution_brief", return_value=exported) as mock_export, patch(
        ...
        response = client.post(
            ...
            json={
                "project_path": "/Users/martin/Desktop/autopilot/projects/autopilot-child",
                "priority": "high",
                "launch": False,
            },
        )
...
def test_tournament_preparation_endpoint_returns_wizard_ready_payload():
    ...
    store.update(
        ...
        workspace_paths=[
            "/Users/martin/Desktop/Projects/graphrag-affiliate",
            "/Users/martin/Desktop/autopilot",
        ],
    )
    ...
    preparation = TournamentPreparation(
        ...
        contestants=[
            TournamentCandidate(
                ...
                source_workspace_path="/Users/martin/Desktop/Projects/graphrag-affiliate",
            ),
            TournamentCandidate(
                ...
                source_workspace_path="/Users/martin/Desktop/autopilot",
            ),
        ],
        agents=[
            AgentConfig(role="contestant_1", provider="claude", tools=["web_search"], workspace_paths=["/Users/martin/Desktop/Projects/graphrag-affiliate"]),
            AgentConfig(role="contestant_2", provider="codex", tools=["code_exec"], workspace_paths=["/Users/martin/Desktop/autopilot"]),
            ...
            return_value=[
                {
                    ...
                    "path": "/Users/martin/.autopilot/projects/autopilot-winner",
                    "priority": "high",
                    "archived": False,
                    "status": "paused",
                    "paused": True,
